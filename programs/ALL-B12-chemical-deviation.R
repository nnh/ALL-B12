...
prtpath <- "//192.168.200.222/Datacenter/Trials/JPLSG/22_ALL-B12/04.03.02 定期モニタリングレポート/第14回/R/CRFreview"
# 締め切り日、ダウンロード日の
flg <- 2  # 1:締め切り日1つ設定バージョン、2:定モニバージョン（startの日も設定）
kDateShimekiri_start <- "2019601"  # flg==2の時に設定
kDateShimekiri <- "20191130"
kDownLoadDate <- "_200122_1023"
kJplsg <- "JPLSG_registration_200122_0925.csv"
#-------------------------------------------------------------------------------------------------------------------
